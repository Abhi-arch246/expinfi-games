...
<html lang="en" dir="ltr">
  ...
  <body style="background:rosybrown;">
    ...
    <div class="content" style="background:rosybrown;">
        <h1 class="text-center text-white font-weight-bold">Decimal Addition Assessment</h1>
        <?php 
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        Swal.fire({
        title: 'Are you sure?',
        html: 'You want to start the assessment?<br><b>Do it in zig-zag left to right<b>',
        icon: 'info',
    ...
    var test_name="Decimal Addition";
    var test_category="Advanced";
    ...
    var question_no = 1;
    var isfive = false;
    let first=getRandomFloat(1,9,1);
    let second=getRandomFloat(1,9,1);
    let third=getRandomFloat(1,9,1);
    let fourth=getRandomFloat(1,9,1);
    let fifth=getRandomFloat(1,9,1);
    ...
    let oans=first+second+third+fourth+fifth;
       ...
       if(question_no < 5){
        ...
        if(ques<=5){ 
           ...
           console.log(question_no);
            ...
            $("#userinput").val('');
            first=getRandomFloat(1,9,1);
            second=getRandomFloat(1,9,1);
            third=getRandomFloat(1,9,1);
            fourth=getRandomFloat(1,9,1);
            fifth=getRandomFloat(1,9,1);
            ...
            oans=first+second+third+fourth+fifth;
       }
