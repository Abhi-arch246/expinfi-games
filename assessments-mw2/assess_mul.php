...
<html lang="en" dir="ltr">
  ...
  <body style="background:crimson;">
    ...
    <div class="content" style="background:crimson;">
        <h1 class="text-center text-white font-weight-bold">Multiplication Assessment</h1>
        <?php 
                 ...
                 <div class="">
                     <div class="row mt-5 py-4 ">
                        ...
                        <div id="question_part" class="mx-auto pt-4 col-md-4">
                            <h2 class="d-inline text-white" id="firstq"></h2>
                            <h2 class="d-inline text-white">x</h2>
                            <h2 class="d-inline text-white" id="secondq"></h2>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        Swal.fire({
        title: 'Are you sure?',
        html: 'You want to start the assessment?<br><b>Do it entirely in your head using visualiation bubble<b>',
        icon: 'info',
    ...
    let second=getRandomNumber(2,9);

    $("#firstq").text(""+first);
    $("#secondq").text(""+second);
    let oans=first*second;
