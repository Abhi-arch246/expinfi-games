                 ...
                 <div class="">
                     <div class="row mt-5 py-4 ">
                        ...
                        <div id="question_part" class="mx-auto pt-4 col-md-4">
                            <h2 class="text-white ml-3" id="firstq"></h2>
...
<script type="text/javascript">
    ...
    var question_no = 1;
    var isfive = false;
    let first=getRandomNumber(60,100);
    let second=getRandomNumber(10,60);
       ...
       if(question_no < 10){
        ...
        if(ques<=10){ 
           ...
           console.log(question_no);
            ...
            $("#userinput").val('');
            first=getRandomNumber(60,100);
            second=getRandomNumber(10,60);
