...
<html lang="en" dir="ltr">
  ...
  <body style="background:orangered;">
    ...
    <div class="content" style="background:orangered;">
        <h1 class="text-center text-white font-weight-bold">Squares Assessment</h1>
        <?php 
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        Swal.fire({
        title: 'Are you sure?',
        html: 'You want to start the assessment?<br><b>Do it using mathemeticians way of solving<b>',
        icon: 'info',
    ...
    var question_no = 1;
    var isfive = false;
    let first=getRandomNumber(20,120);

    $("#firstq").text(""+first);
    $("#secondq").text(""+first);
    let oans=first*first;
