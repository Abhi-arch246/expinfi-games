...
<div class="bg-secondary mt-4 rounded p-2 text-white">
    <h5 class="text-center mt-2">Hello all welcome to the workshop of Mathlete Young Wizards,hope you're doing well</h5>
...
<div class="container">
    ...
    <div class="row" style="margin-top:30px;">
        <?php
        $exam="SELECT * FROM exams WHERE batchid='MYW'";
