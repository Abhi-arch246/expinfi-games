...
<html lang="en" dir="ltr">
  ...
  <body style="background:seagreen;">
    ...
    <div class="content">
        <h1 class="text-center text-white font-weight-bold">Subtraction Assessment</h1>
        <?php 
                 ...
                 <div class="">
                     <div class="row mt-5 py-4 ">
                        ...
                        <div id="question_part" class="mx-auto pt-4 col-md-4">
                            ...
                            <h2 class="text-white ml-2" id="thirdq"></h2>
                            <h2 class="text-white" id="fourthq"></h2>
                            <h2 class="text-white" id="fifthq"></h2>
                            <h2 class="text-white ml-2" id="sixthq"></h2>
...
<script type="text/javascript">
    ...
    var question_no = 1;
    var isfive = false;
    let first=getRandomNumber(100,999);
    let second=getRandomNumber(100,999);
    let third=getRandomNumber(100,999);
    let fourth=getRandomNumber(100,999);
    let fifth=getRandomNumber(100,999);
    let sixth=getRandomNumber(100,999);
       ...
       if(question_no < 20){
        ...
        if(ques<=20){ 
           ...
           console.log(question_no);
            ...
            $("#userinput").val('');
            first=getRandomNumber(100,999);
            second=getRandomNumber(100,999);
            third=getRandomNumber(100,999);
            fourth=getRandomNumber(100,999);
            fifth=getRandomNumber(100,999);
            sixth=getRandomNumber(100,999);
